class DiceController < UIViewController
  def viewDidLoad
    ...
    @d6 = DiceLabelBuilder.build(:dimensions => [[80, 30], [80, 40]])
    view.addSubview(@d6)

    @d6_button = DiceButtonBuilder.build(:text => "d6", :dimensions => [[20, 30], [40, 40]])
    ...
    @d8 = DiceLabelBuilder.build(:dimensions => [[80, 80], [80, 40]])
    view.addSubview(@d8)

    @d8_button = DiceButtonBuilder.build(:text => "d8", :dimensions => [[20, 80], [40, 40]])
    ...
    @d10 = DiceLabelBuilder.build(:dimensions => [[80, 130], [80, 40]])
    view.addSubview(@d10)

    @d10_button = DiceButtonBuilder.build(:text => "d10", :dimensions => [[20, 130], [40, 40]])
    ...
    @d12 = DiceLabelBuilder.build(:dimensions => [[80, 180], [80, 40]])
    view.addSubview(@d12)

    @d12_button = DiceButtonBuilder.build(:text => "d12", :dimensions => [[20, 180], [40, 40]])
    ...
    @d20 = DiceLabelBuilder.build(:dimensions => [[80, 230], [80, 40]])
    view.addSubview(@d20)

    @d20_button = DiceButtonBuilder.build(:text => "d20", :dimensions => [[20, 230], [40, 40]])
